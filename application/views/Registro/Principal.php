      ...
      <body>
        <div id="header">
          ...
          <div id="menu" class="barraMenu">
            ...
            <nav>
              <ul>
                <li><a class="botonMenu" href="#">Inicio</a></li>
        ...
        <div id="cuerpo">
          <div id="portada">
            <img src="images/portal de registro.jpg" width="100%"></img>
            <a href="<?php echo base_url('registro/candidato') ?>">Candidato</a>
            <a href="<?php echo base_url('registro/empresa') ?>">Empresa</a>
          </div>
        </div>
        <div id="footer">
          <div id="footer2">
