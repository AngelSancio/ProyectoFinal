      ...
      <header>
        ...
        <div id="registro">
            ...
            <table  id="tablaRegistro">
              <tr>
                <td> <button  type="submit" name="candidato" id="boton" onclick="<?php echo base_url('candidato') ?>">CANDIDATO</button> </td>
              <td><button type="submit" name="empresa" id="boton" onclick="<?php echo base_url('empresa') ?>"> EMPRESA</button></td>
                     </tr>
          </table>
            </div>
    </header>
